namespace HackF5.UnitySpy.AvaloniaGui.ViewModel
{
    ...
    public class AssemblyImageViewModel : ReactiveObject
    {
        ...
        private readonly ObservableCollection<TypeDefinitionViewModel> filteredTypes;
        ...
        private void Init()
        {
            this.types.AddRange(new List<TypeDefinitionViewModel>(this.image.TypeDefinitions.OrderBy(td => td.FullName)
